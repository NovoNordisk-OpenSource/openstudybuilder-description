...
![Figure 1: The four-tier model for engaging with OpenStudyBuilder](./img/collab_tiers_01.png){: .imageNoBorder}
...
The tier model is about collaboration - **not about access**.
...
The tier structure simply defines different ways of collaborating. Tier 2 and Tier 3 include defined commitments and collaboration principles, Tier 4 simply requires the willingness to be publicly associated with the initiative, and Tier 1 will become available once the corresponding legal entity has been established.
